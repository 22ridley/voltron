...
CREATE TABLE user (user_id int NOT NULL AUTO_INCREMENT, user_name varchar(255), email varchar(255) UNIQUE, privilege int, PRIMARY KEY (user_id));
...
CREATE TABLE `group` (group_id int NOT NULL AUTO_INCREMENT, group_name varchar(255) UNIQUE, class_id int, PRIMARY KEY(group_id), FOREIGN KEY(class_id) REFERENCES class(class_id))
...
INSERT INTO `group` (group_name, class_id) VALUES ("1", 1)    -- 1
INSERT INTO `group` (group_name, class_id) VALUES ("2", 1) -- 2
